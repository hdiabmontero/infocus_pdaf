...
! *** Filter specific variables
  filtertype = 2    ! Type of filter
                    ...
                    !   (6) ESTKF
                    !   (7) LESTKF
  dim_ens = 10       ! Size of ensemble for all ensemble filters
...
! *** specifications for observations ***
  rms_obs = 0.5*1e6    ! Observation error standard deviation
